            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="images/anusha.jpg" width="400" height="600" alt="team 1">
                            <h3>Anusha</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="images/amlan.jpg"  alt="team 1">
                            <h3>Amlan Das</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            <img src="images/supratim.jpg" width="400" height="190" alt="team 1">
                            <h3> Supratim</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
