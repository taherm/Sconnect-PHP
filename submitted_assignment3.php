                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
							...
							<li class="active"><a href="selectsubmitted_assignment.php">Back</a></li>
        ...
        <div class="section secondary-section">
            ...
            <div class="container centered">                
				...
				<table width="80%" border="4px solid">
					<tr>
					<th colspan="6"><h2>Assignments Uploaded</h2></th>
					</tr>
					<tr>
					<th>File Name</th>
					<th>Sem</th>
					...
					<th>View</th>
						...
						<?php					 
							...
							//echo "sem:::$s";
*/
							$sql="SELECT * from data2 where sem=3";
						  ...
						  ?>
								...
								<td><a href="assignment/3/<?php echo $row['file'] ?>" target="_blank">View File</a></td>
								</tr>
								<?php
						 }
						 ?>
