...
<div class="large-12 columns extra-padding">
  <div class="container" rel="stylesheet" href="../cssforum/style.css">
		<center><h2>Forum</h2>
  <i>&nbsp;&nbsp;Ask your doubts and wait for the response...</i></center>
<?php
	error_reporting(0);
	$connection = new mysqli('localhost', 'root', '', 'sc');
	if (isset($_POST['msg']) === true) {
		session_start(); 
        $put_user = $_SESSION['login_teacher'];
		//$put_user = shaggy;
...
?>
  <hr/>
	...
	<form action="" method="post">
		<textarea name="msg"  rows="4" style="width: 1050px;"placeholder="What's on your mind?"></textarea>
			...
			<table style="width: 100%;">
				<tr>
					<td colspan="2">
						...
						<?php //add mail id needed ?>
						<p style="margin-top: -5px; font-size: 15px; color: black;"><i>Date and Time of the post:</i> <?php  echo $row[4]; ?> </p>
					</td>
				</tr>
				<tr>
					<td colspan="3" height="10" ><br>
					<p style="margin-top: 10px; padding-left: 50px; padding-right: 20px; color: black;"> <?php echo ' " '. nl2br($row[2]) . ' " '; ?></p></td>
				</tr>
				<tr>
					<td colspan="3"></td>
				</tr>
