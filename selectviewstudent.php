                ...
                <div class="title">
				 ...
				 <div>
					<div class="price-table">
                        ...
                        <ul class="list">
                            <li class="price"><a href="viewstudents1.php" class="button button-ps">1st year</a></li>
                            <li><a href="viewstudents2.php" class="button button-ps">2nd Year</a></li>
							<li><a href="viewstudents3.php" class="button button-ps">3rd Year</a></li>
                            </ul>
