...
<div class="navbar">
 ...
 <div id="admin" class="section secondary-section">
            <div class="container">
                <div class="title">
                    <h1>View Students</h1>
                    <p>Select year to get details of students of the current batches pursuing their degree</p>
                </div>
				 <div>
					<div class="price-table">
						<div class="span4 price-column">
                        <ul class="list">
                            <li class="price"><a href="viewstudents1ft.php" class="button button-ps">1st year</a></li>
                            <li><a href="viewstudents2ft.php" class="button button-ps">2nd Year</a></li>
							<li><a href="viewstudents3ft.php" class="button button-ps">3rd Year</a></li>
                            </ul>
			  ...
			  <div class="modal-content">
				...
				<div id = "loginform">
					...
					<form method = "post" action = "ta.php">
						...
						<input type = "text" id = "sname" name = "logg" placeholder = "Full Name"   >
